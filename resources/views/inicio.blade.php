...
<header class="topbar">
  ...
  <div class="userchip">
    <div class="av">P</div>
    <div class="txt"><b>Preceptoría</b><span>Usuario</span></div>
  </div>
</header>
...
<div class="layout">
  <div class="sidebar">
    ...
    <a class="salir" href="login.html"><span class="ic"></span>Cerrar sesión</a>
  </div>

  <div class="contenido">
    <div class="panel-card">
      <h3>¡Bienvenido/a! <span class="badge-rol Preceptor">Preceptoría</span></h3>
      <p class="sub">Panel principal · Resumen general del sistema</p>
      <p class="tip">Solo ves los cursos que tenés a cargo: 4° 1° y 6° 3°. No podés editar legajos, ni crear legajos nuevos, ni ver los legajos de egresados.</p>
    </div>
    ...
    <p class="section-sub">2 curso(s) disponibles para tu usuario.</p>

    <div class="cursos-cols">
      <div class="curso-col">
        <div class="titulo-col"><span class="dot manana"></span>Turno Mañana</div>
        <div class="empty">Sin cursos asignados</div>
      </div>
      <div class="curso-col">
